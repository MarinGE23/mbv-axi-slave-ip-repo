# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-perceptron\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-perceptron\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-perceptron\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  axi_perceptron_0: axi_perceptron@44a00000 {
   xlnx,perceptron-w = <8>;
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,axi-perceptron-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <5>;
   xlnx,ip-name = "axi_perceptron";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a00000 0x10000>;
   xlnx,perceptron-tie-is-one = "0";
   xlnx,name = "axi_perceptron_0";
  };
...
# 3 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-perceptron\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "basys3";
 ...
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x8000>,
         ...
         <0x44a00000 &axi_perceptron_0 0x44a00000 0x10000>;
