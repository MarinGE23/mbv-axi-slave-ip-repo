...
// Date        : Tue Sep 30 20:38:32 2025
// Host        : Emanuel running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_axi_trng_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_axi_trng_0_0,axi_trng,{}" *) (* CORE_GENERATION_INFO = "design_1_axi_trng_0_0,axi_trng,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=axi_trng,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=5,NUM_RO=8,RO_STAGES=5,SAMPLE_DIV_WIDTH=16,RCT_MAX_RUN=64,APT_WIN_SIZE=512,APT_LOW_THRESH=192,APT_HIGH_THRESH=320,DEFAULT_LOW=0,DEFAULT_HIGH=100}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
