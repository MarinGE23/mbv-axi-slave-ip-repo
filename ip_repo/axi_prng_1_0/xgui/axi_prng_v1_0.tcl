...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DEFAULT_SEED"
...
proc update_PARAM_VALUE.DEFAULT_SEED { PARAM_VALUE.DEFAULT_SEED } {
	# Procedure called to update DEFAULT_SEED when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DEFAULT_SEED { PARAM_VALUE.DEFAULT_SEED } {
	# Procedure called to validate DEFAULT_SEED
	return true
}
...
proc update_MODELPARAM_VALUE.DEFAULT_SEED { MODELPARAM_VALUE.DEFAULT_SEED PARAM_VALUE.DEFAULT_SEED } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DEFAULT_SEED}] ${MODELPARAM_VALUE.DEFAULT_SEED}
}
