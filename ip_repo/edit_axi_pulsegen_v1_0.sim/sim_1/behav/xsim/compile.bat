...
REM
REM Generated by Vivado on Sat Oct 25 12:32:56 -0600 2025
...
echo "xvlog --incr --relax -prj pulsegen_tb_vlog.prj"
call xvlog  --incr --relax -prj pulsegen_tb_vlog.prj -log xvlog.log
