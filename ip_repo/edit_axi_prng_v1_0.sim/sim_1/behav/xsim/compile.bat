...
REM
REM Generated by Vivado on Wed Oct 01 05:32:07 -0600 2025
...
echo "xvlog --incr --relax -prj xorshift32_rng_tb_vlog.prj"
call xvlog  --incr --relax -prj xorshift32_rng_tb_vlog.prj -log xvlog.log
