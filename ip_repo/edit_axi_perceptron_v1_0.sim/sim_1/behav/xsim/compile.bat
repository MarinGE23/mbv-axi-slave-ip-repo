...
REM
REM Generated by Vivado on Sat Nov 15 20:37:01 -0600 2025
...
echo "xvlog --incr --relax -prj binary_perceptron_tb_vlog.prj"
call xvlog  --incr --relax -prj binary_perceptron_tb_vlog.prj -log xvlog.log
