...
REM
REM Generated by Vivado on Thu Oct 02 08:57:23 -0600 2025
...
echo "xvlog --incr --relax -prj display_decoder_tb_vlog.prj"
call xvlog  --incr --relax -prj display_decoder_tb_vlog.prj -log xvlog.log
