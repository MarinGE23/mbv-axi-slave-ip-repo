...
comp = client.get_component(name="pulsegen_test_app")
status = comp.import_files(from_loc="$COMPONENT_LOCATION/../platform/hw/sdt/drivers/axi_pulsegen_v1_0/src", files=["axi_pulsegen.c", "axi_pulsegen.h"], dest_dir_in_cmp = "src")
