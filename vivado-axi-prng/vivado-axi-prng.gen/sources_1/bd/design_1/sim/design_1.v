...
module design_1
   (prng_reset_0,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.PRNG_RESET_0 RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PRNG_RESET_0, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input prng_reset_0;
  ...
  design_1_axi_prng_0_0 axi_prng_0
       (.prng_reset(prng_reset_0),
