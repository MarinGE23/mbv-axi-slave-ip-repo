...
HD_PWD='C:/Users/emari/Desktop/mbv-axi-slave-ip-repo/vivado-axi-prng/vivado-axi-prng.runs/design_1_axi_prng_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_prng_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_prng_0_1.tcl
