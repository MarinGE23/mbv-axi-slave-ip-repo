...
HD_PWD='C:/Users/emari/Desktop/mbv-axi-slave-ip-repo/vivado-axi-secure-auth/vivado-axi-secure-auth.runs/design_1_axi_trng_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_trng_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_trng_0_0.tcl
