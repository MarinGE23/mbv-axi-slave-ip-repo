# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-secure-auth\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-secure-auth\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-secure-auth\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  axi_7seg_0: axi_7seg@44a10000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,axi-7seg-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <4>;
   xlnx,ip-name = "axi_7seg";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a10000 0x10000>;
   xlnx,name = "axi_7seg_0";
  };
  axi_trng_0: axi_trng@44a00000 {
   compatible = "xlnx,axi-trng-1.0";
   xlnx,s00-axi-data-width = <32>;
   xlnx,sample-div-width = <16>;
   ...
   xlnx,num-ro = <8>;
   status = "okay";
   xlnx,apt-low-thresh = <192>;
   xlnx,s00-axi-addr-width = <5>;
   xlnx,name = "axi_trng_0";
  };
...
# 3 "C:\\Users\\emari\\Desktop\\mbv-axi-slave-ip-repo\\vitis-axi-secure-auth\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "basys3";
 ...
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
         ...
         <0x44a00000 &axi_trng_0 0x44a00000 0x10000>,
         <0x44a10000 &axi_7seg_0 0x44a10000 0x10000>;
